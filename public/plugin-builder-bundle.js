...
Component.options.__file = "plugins/PluginBuilder/Assets/admin/js/components/+visual-builder/main.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0fe3ac62", Component.options)
  } else {
    hotAPI.reload("data-v-0fe3ac62", Component.options)
' + '  }
...
var _vuedraggable = __webpack_require__(112);
...
var VisualBuilder = (_dec = (0, _vueClassComponent2.default)({
    components: {
        draggable: _vuedraggable2.default
    }
}), _dec(_class = function (_Vue) {
    _inherits(VisualBuilder, _Vue);

    function VisualBuilder() {
        _classCallCheck(this, VisualBuilder);

        return _possibleConstructorReturn(this, (VisualBuilder.__proto__ || Object.getPrototypeOf(VisualBuilder)).apply(this, arguments));
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0fe3ac62", module.exports)
  }
}
